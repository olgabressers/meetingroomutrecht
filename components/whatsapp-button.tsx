...
export function WhatsAppButton({ locale }: { locale: Locale }) {
  const message = dict[locale].whatsapp
  const href = `https://wa.me/31647779797?text=${encodeURIComponent(message)}`
  ...
  return (
    <a
      ...
      aria-label={locale === 'nl' ? 'Chat met ons via WhatsApp' : 'Chat with us on WhatsApp'}
